...
const Footer = () => {
  return <div className='footer'>
    ...
    <div className='footer-down'>
      <div>Giấy CNĐKDN: 0310874914 – Ngày cấp: 25/11/2011 - Cơ quan cấp: Phòng Đăng Ký Kinh Doanh – Sở Kế Hoạch và Đầu Tư TP.HCM</div>
      <div>Địa chỉ đăng ký kinh doanh: 766/3B-3C Sư Vạn Hạnh, Phường 12, Quận 10, TP.HCM - Điện thoại: (028) 3868 4857 - Mua hàng: (028) 7307 1441 - Email: cskhLT@gmail.com</div>
    </div>
  </div>
};
