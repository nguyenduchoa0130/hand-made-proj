...
function Order() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, item) => (
        <div className='price'>
          <span className='priceOld'>{item.oldPrice.toLocaleString('en-US')}đ</span>
          {item.newPrice.toLocaleString('en-US')}đ
        </div>
      ),
    },
    {
    ...
    },
    {
      ...
      key: 'action',
      align: 'right',
      render: (_, record) => <button className='button-delete'>Xóa</button>,
    },
  ];
